...
export function AnimatedBackground({ type }: AnimatedBackgroundProps) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View
        style={[styles.gradient, { backgroundColor: colors[1], opacity: 0.7 }]}
      />
      <View
        style={[styles.gradient, { backgroundColor: colors[2], opacity: 0.5 }]}
      />
...
function RainDrop({ delay }: { delay: number }) {
  ...
  return <Animated.View style={[styles.rainDrop, { left }, animatedStyle]} />;
}
...
function Snowflake({ delay }: { delay: number }) {
  ...
  return <Animated.View style={[styles.snowflake, { left }, animatedStyle]} />;
}
...
function SunGlowAnimation() {
  ...
  return <Animated.View style={[styles.sunGlow, animatedStyle]} />;
}
...
function Cloud({ delay, top }: { delay: number; top: number }) {
  ...
  return <Animated.View style={[styles.cloud, { top }, animatedStyle]} />;
}
